...
void ATinoController::InitializeUIInstance()
{
	...
	if (!!CouponDialogUIWidgetClass)
	{
		if (CouponDialogUIInstance == nullptr)
			CouponDialogUIInstance = CreateWidget<UCouponDialogWidget>(GetWorld(), CouponDialogUIWidgetClass);
	}
}
